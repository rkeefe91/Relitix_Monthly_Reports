...
/****** Object:  StoredProcedure [dbo].[SCWMLS_PriceRangeStats_Group2]    Script Date: 5/19/2020 2:50:37 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SCWMLS_PriceRangeStats_Group2] 
...
on cbr.County=RTRIM(LTRIM(REPLACE(cn.County_name,'County','')))
			where (lc.sourcesystemid = 1 OR lc.sourcesystemID = 4 OR lc.sourcesystemID=8)
				...
				and g.statefp = 55
				and cbr.Region='Crawford/Richland/Vernon'
				),
